...
import { TextDisplayModalComponent } from '../../../text-display-modal/text-display-modal.component';
...
@Component({
  ...
  styleUrl: './truncated-text-details.component.scss'
})
export class TruncatedTextDetailsComponent {
  /**
  ...
  protected openFullTextModal(): void {
    this.dialog.open(TextDisplayModalComponent, {
      data: {
