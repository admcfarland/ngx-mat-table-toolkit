...
import { MttTableColumnService } from './mtt-table-column.service';
import { Column } from '../models/column.model';

describe('MttTableColumnService', () => {
  let service: MttTableColumnService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(MttTableColumnService);
  });
